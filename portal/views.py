...
The view functions decorated by the @route decorator have access to the request and response objects
in the decorator's namespace.

For documentation on the decorator pattern and the @current_app.route decorators, see decorators.py
'''
...
@current_app.route('/hardware')
def hardware():
    return render_template('hardware.html')


@current_app.route('/hardware/gpus')
def get_gpus():
...
@current_app.route('/profile/create', methods=['GET', 'POST'])
@decorators.login_required
def create_profile():
    try:
...
@current_app.route('/profile/groups')
@decorators.login_required
def user_groups():
    return render_template('user_groups.html')


@current_app.route('/profile/get_user_groups')
@decorators.login_required
def get_user_groups():
    unix_name = session['unix_name']
...
@current_app.route('/profile/request_membership/<unix_name>')
@decorators.login_required
...
@current_app.route('/jupyterlab/configure')
@decorators.members_only
...
@current_app.route('/jupyterlab/deploy', methods=['POST'])
@decorators.members_only
...
@current_app.route('/jupyterlab/remove/<notebook>')
@decorators.members_only
...
@current_app.route('/admin/notebooks')
@decorators.admins_only
def open_notebooks():
    return render_template('notebooks.html')


@current_app.route('/admin/list_notebooks')
@decorators.admins_only
def list_notebooks():
...
@current_app.route('/admin/get_notebook/<notebook_name>')
@decorators.admins_only
...
@current_app.route('/admin/get_user_profiles')
@decorators.admins_only
...
@current_app.route('/admin/plot_users_over_time')
@decorators.admins_only
...
@current_app.route('/admin/kibana')
@decorators.admins_only
def kibana_admin():
...
@current_app.route('/admin/groups/<group_name>')
@decorators.admins_only
...
@current_app.route('/admin/get_members/<group_name>')
@decorators.admins_only
...
@current_app.route('/admin/get_member_requests/<group_name>')
@decorators.admins_only
...
@current_app.route('/admin/get_subgroups/<group_name>')
@decorators.admins_only
...
@current_app.route('/admin/get_potential_members/<group_name>')
@decorators.admins_only
...
@current_app.route('/admin/email/<group_name>', methods=['POST'])
@decorators.admins_only
...
@current_app.route('/admin/add_group_member/<group_name>/<unix_name>')
@decorators.admins_only
...
@current_app.route('/admin/remove_group_member/<group_name>/<unix_name>')
@decorators.admins_only
...
@current_app.route('/admin/approve_membership_request/<group_name>/<unix_name>')
@decorators.admins_only
...
@current_app.route('/admin/deny_membership_request/<group_name>/<unix_name>')
@decorators.admins_only
...
@current_app.route('/admin/edit_group/<group_name>', methods=['GET', 'POST'])
@decorators.admins_only
...
@current_app.route('/admin/create_subgroup/<group_name>', methods=['GET', 'POST'])
@decorators.admins_only
...
@current_app.route('/admin/remove_group/<group_name>')
@decorators.admins_only
...
@current_app.route('/admin/login_nodes')
@decorators.admins_only
def login_nodes():
