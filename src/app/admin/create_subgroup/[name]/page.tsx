...
import { createSubgroupAction } from "./actions";

export const metadata = { title: "Analysis Facility - Create Subgroup" };

export default async function CreateSubgroupPage({
  params,
}: {
  ...
  if (!group) notFound();
  const action = createSubgroupAction.bind(null, name);
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto">
            <h4 className="mt-3">Create subgroup</h4>
            ...
            <form action={action}>
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" name="short-name" required />
              </div>
              <div className="mb-3">
                <label className="form-label">Display name:</label>
                <input type="text" className="form-control" name="display-name" required />
              </div>
              <div className="mb-3">
