...
![ATLAS Authz authentication to Coffea-casa Analysis Facility @ UChicago](img/atlas-auth.web.cern.ch_login.png)

![Approval required for CMS Authz authentication to Coffea-casa Analysis Facility @ UChicago](img/coffea-casa-authz-approval.png)
...
This behaves exactly like the _New Launcher_ option above.
